    ...
    <section class="content">
      <div class="box box-danger">
      	<div class="box-header with-border">
         	<a href="${ctx }/op/application/edit" class="btn btn-info btn-flat">
         ...
         <div class="box-body">
           ...
           <c:forEach var="a" items="${pageModel.list }">
             <tr>
               ...
               <td>
               	 <a href="${ctx }/op/application/edit?id=${a.id}" class="btn btn-xs btn-info btn-flat">修改</a>
               </td>
             </tr>
           </c:forEach>
           </tbody>
